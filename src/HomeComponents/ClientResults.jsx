...
const ClientResults = () => {
    return (
        <div className='bg-black w-full'>
            <h1 className="text-4xl text-white font-poppins-bold text-center  md:mb-0 md:text-6xl">
                Client Results
            </h1>
            ...
            <div className='flex justify-center gap-[5rem] pb-10'>
                ...
                <h1 className="text-[1rem]  mt-2   text-white font-poppins text-center my-3 md:mb-0 md:text-3xl">
                    (30M+ Views Generated)
                </h1>
