                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                            Founded by a duo of a Tech-Driven Developer and a Cinematic Storyteller, VzualVibe is where code meets creativity.
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    >
                        ...
                        <motion.div variants={fadeIn} className="group">
                            <div className="relative aspect-4/5 rounded-3xl overflow-hidden mb-6 border border-neutral-800 group-hover:border-amber-500/50 transition-colors duration-500">
                                ...
                                <div className="absolute bottom-0 left-0 p-8 z-30">
                                    <h3 className="text-3xl font-bold text-white mb-2">Shivam Mishra</h3>
                                    <p className="text-amber-500 font-medium">Creative Motion Graphics Designer & MERN Stack Developer</p>
                                </div>
                            </div>
                            <p className="text-gray-400 text-lg leading-relaxed px-2">
                                As a MERN Stack Developer and Motion Graphics Designer, I don’t just build websites; I create digital experiences. With a deep expertise in AI integration and autonomous agents, I bridge the gap between high-end code and cinematic storytelling. Whether it's a seamless web app or a high-impact motion piece, I ensure every pixel and every line of code is designed to scale your brand.
                            </p>
                        </motion.div>
                        ...
                        <motion.div variants={fadeIn} className="group">
                            <div className="relative aspect-4/5 rounded-3xl overflow-hidden mb-6 border border-neutral-800 group-hover:border-amber-500/50 transition-colors duration-500">
                                ...
                                <div className="absolute bottom-0 left-0 p-8 z-30">
                                    <h3 className="text-3xl font-bold text-white mb-2">Shubham Mishra</h3>
                                    <p className="text-amber-500 font-medium">Lead Editor & Co-Founder</p>
                                </div>
                            </div>
                            <p className="text-gray-400 text-lg leading-relaxed px-2">
                                Shubham is the Lead Editor and Co-Founder of VzualVibe. With years of professional experience in high-end video production, he bridges the gap between raw footage and powerful brand stories. His leadership ensures that our creative output stays ahead of the curve, delivering world-class visuals that resonate with global audiences.
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
